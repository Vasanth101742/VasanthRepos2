...
forecaststeps=3
df=SourceData_Europe.df_DFUwise_Monthwise
...
df_final = pd.DataFrame(columns=['Region','DFUCode','India_tpl','MonthEndDate','Index_date','Qty','Index_date2','y_pred'])
...
for i in Region:
    ...
    for j in DFUCode:
        ...
        filtered_df = df[(df['Region'] == i) & (df['DFUCode'] == j)]
        ...
        DateMapping = {'Index_date': ['2025-08-01', '2025-08-02', '2025-08-03','2025-08-04','2025-08-05',
                            ...
                            'Monthend_date': ['2023-09-30','2023-10-31','2023-11-30','2023-12-31','2024-01-31',
        ...
        #print(df1_stage)
        df1_new=pd.DataFrame(columns=['Region','DFUCode','India_tpl','MonthEndDate','Qty'])
        df1_new[['Region','DFUCode','India_tpl','Index_date','MonthEndDate','Qty']]=df1_stage[['Region','DFUCode','India_tpl','Index_date','MonthEndDate','Qty']].reset_index(drop=True)    
        #print(df1_new)
        ...
        pred_model=predict_model(best,fh=9,verbose=False)
       ...
       # View the predictions and associated metrics
        ...
        df_combined = pd.concat([df1_new[['Region','DFUCode','India_tpl','MonthEndDate','Index_date','Qty']], pred_model2[['Index_date2','y_pred',"best_model_name","elapsed_mins"]]], ignore_index=True)
        #print("df_combined :\n",df_combined)
        ...
        conn_str =SourceData_Europe.conn_str
        quoted = urllib.parse.quote_plus(conn_str)
 
        insert_sql = "INSERT INTO dbo.SalesQtyForecast_Europe (Organ,DFUCode,India_tpl,MonthendDate,IndexDate,Qty,ModelName,Elapsed_mins)VALUES (?,?,?,?,?,?,?,?)"
        ...
        df_final2=df_final[['Region','DFUCode','India_tpl','MonthEndDate','Index_date','Qty',"best_model_name","elapsed_mins"]]
        #print(df_final2['Qty'])
