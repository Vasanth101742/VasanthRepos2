...
# Debug: print every element and its namespace
print("\n========== XML ELEMENTS ==========")
...
# Find GetDFUResponse anywhere in the document
#RegionWiseDFU = root.findall(".//reg:GetDFUResponse",ns

RegionWiseDFU = root.findall(".//GetDFUResponse")


print("\n========== GetDFUResponse ==========")
print("Number found:", len(RegionWiseDFU))


for Region in RegionWiseDFU:
