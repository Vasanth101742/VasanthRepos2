...
for i in Organ:
    ...
    for j in Item:
        ...
        df_combined = pd.concat([df1_new[['Organ','item','Item_desc','MonthEndDate','Index_date','Qty']], pred_model2[['Index_date2','y_pred',"best_model_name","elapsed_mins"]]], ignore_index=True)
        #print("df_combined :\n",df_combined)
        ...
        insert_sql = "INSERT INTO dbo.SalesQtyForecast (Organ,Item,Item_desc,MonthendDate,IndexDate,Qty,ModelName,Elapsed_mins)VALUES (?,?,?,?,?,?,?,?)"
        ...
        df_final2=df_final[['Organ','item','Item_desc','MonthEndDate','Index_date','Qty',"best_model_name","elapsed_mins"]]
