#Ref :https://www.analyticsvidhya.com/blog/2022/06/time-series-forecasting-using-python/


#It relies on historical data to identify patterns, trends, and seasonal variations, 
# allowing analysts to make informed predictions about future outcomes.
...
plt.plot(data.invoice_date,data.Qty)
...
result = adfuller(data['invoice_date'])
